...
public class FillForm extends PageObject {
    ...
    public static final Target CONTINUE_PAY = Target.the("continue").located(By.xpath("//*[@id=\"fbra_checkoutRegionAndComuna\"]/div/section/section/form/div/div[4]/div/button"));
